        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="space-y-3 text-center md:text-left">
              ...
              <p className="text-slate-400 text-xs">© 2026 BookiSmartIA</p>
            </div>
            ...
            <div className="flex flex-col items-center space-y-3">
              ...
              <div className="flex gap-3">
                {/* ✅ Instagram */}
                <a
                  href="https://www.instagram.com/eliza_neira1?igsh=bTc5aGd6aDAzMDh4"
                  target="_blank"
                ...
                {/* ✅ YouTube */}
                <a
                  href="https://www.youtube.com/watch?v=fBJ27sjSmDg"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            <div className="flex flex-col items-center md:items-end space-y-2 text-center md:text-right">
              ...
              <p className="text-slate-600 text-xs">Desarrollo de Software • M6A</p>
            </div>
          </div>
